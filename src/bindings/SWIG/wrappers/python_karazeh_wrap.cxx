...
/*-----------------------------------------------
              @(target):= _python_karazeh.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__python_karazeh

#else
#  define SWIG_init    init_python_karazeh

#endif
#define SWIG_name    "_python_karazeh"
...
static swig_type_info _swigt__p_std__string = {"_p_std__string", "std::string *|string_t *", 0, 0, (void*)0, 0};
